...
const SetTheme = async(Theme: 'LIGHT' | 'DARK') =>
{
    ...
    let BaseHover: { L: number; C: number; H: number };
    ...
    {
        Base = { L: 98, C: 0, H: 0 };
        BaseText = { L: 2, C: 0, H: 0 };
        BaseHover = { L: 96, C: 0, H: 0 };
        BaseBorder = { L: 90, C: 0, H: 0 };
        BaseReverse = { L: 2, C: 0, H: 0 };
        BaseOutline = { L: 84, C: 0, H: 0 };
        BaseSecondary = { L: 90, C: 0, H: 0 };
    }
    else
    {
        Base = { L: 30.857, C: 0.023, H: 264.149 };
        BaseText = { L: 90, C: 0, H: 0 };
        BaseHover = { L: 26.346, C: 0.018, H: 262.177 };
    ...
    document.documentElement.style.setProperty('--color-base-hover', `oklch(${ BaseHover.L }% ${ BaseHover.C } ${ BaseHover.H })`);
